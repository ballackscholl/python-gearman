...
class GearmanClientCommandHandler(GearmanCommandHandler):
    ...
    def __init__(self, connection_manager=None):
        ...
        self.requests_awaiting_handles = dict()
    ...
    def send_job_request(self, current_request):
        ...
        self.requests_awaiting_handles[current_request.gearman_job.unique] = current_request
    ...
    def on_io_error(self):
        for key in self.requests_awaiting_handles:
            self.requests_awaiting_handles[key].state = JOB_UNKNOWN
    ...
    def recv_job_created(self, job_handle, unique):
        if unique not in self.requests_awaiting_handles:
        ...
        current_request = self.requests_awaiting_handles.pop(unique)
    ...
    def recv_work_data(self, job_handle, data):
        ...
        try:
            ...
            logging.warning('job_handle %s not exist'%job_handle)
            return True
